...
function SoftwareDevelopment({selected}) {
    return (
        <div>
             { (selected.name =='All' || selected.name == 'Software Development')&&
            <div>
            <hr className='hidden md:flex' />
            <div className="lg:grid grid-cols-3 md:py-20 py-10 text-[#4A525D]">
                <div className="flex flex-col gap-3 pb-5 lg:pb-0">
                    <h2 className="text-xl font-bold text-black">Software Development</h2>
                    <p className="">Open positions in our design team</p>
                </div>
                <div className="col-span-2 flex flex-col gap-4">
                {[...Array(3)].map((t,i) => <div key={i} className="border sm:p-8 p-5 rounded-lg flex flex-col gap-9 font-semibold">
                        <div className='flex flex-col sm:gap-2 gap-4'>
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-0 justify-between">
                                <div className="flex gap-3">
                                    ...
                                    <p className="bg-[#F4F5FA] text-sm flex items-center px-2 rounded-full"><Image className='w-5' src={dot} alt="" /> Design</p>
                                </div>
